"""
Drawing service prompts for step generation and translation.

This module contains prompts used by the DrawingService for:
- Generating step-by-step drawing instructions
- Translating drawing steps to German
"""


def get_drawing_steps_generation_prompt(subject: str) -> str:
    """
    Get the prompt for generating step-by-step drawing instructions.

    This prompt is used with GPT-4o-mini to create clear, kid-friendly
    drawing instructions that are descriptive enough for AI accuracy.

    Args:
        subject: The subject to create drawing instructions for (e.g., "dog", "cat")

    Returns:
        str: Prompt for step generation
    """
...
def get_german_translation_prompt(english_steps_text: str) -> str:
    """
    Get the prompt for translating English drawing steps to German.

    Args:
        english_steps_text: Formatted English steps (numbered, one per line)

    Returns:
        str: Prompt for German translation
    """
